...
router.delete('/delete_server/:id', isAuth, async (req:IRequest, res:Response) => {
...
router.delete('/delete_user/:id_user&:id_server', isAuth,  async (req:IRequest, res:Response) => {
